...
MOSES_ATOMS = ("C", "N", "S", "O", "F", "Cl", "Br")  # DeFoG order; neutral, no H
GUACAMOL_ATOMS = ("C", "N", "O", "F", "B", "Br", "Cl", "I", "P", "S", "Se", "Si")  # DeFoG/DiGress order

# Bond class index: 0 = no bond, 1 = single, 2 = double, 3 = triple. Bonds are
# kekulized (aromatic rings become alternating single/double); RDKit re-perceives
# aromaticity at decode from the valence pattern.
N_BOND_CLASSES = 4
_BOND_TO_IDX = {
...
def smiles_to_tensor(smiles: str, atom_vocab=QM9_ATOMS, charge_aware: bool = True):
    ...
    # Kekulize: aromatic rings become alternating single/double, aromatic flags cleared.
